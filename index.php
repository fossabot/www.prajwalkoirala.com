	...
	<div id="wrapper">
		<section id="main">
			...
			<h1>
				...
				<li>
					<style>{margin-top:-.675em} li{display:inline-block;padding:.675em .5em}</style><a href=tel:+1347-349-1993><svg x="0" y="0" width="32" height="32" viewBox="0 0 578.1 578.1" xml:space="preserve">
					...
					<li>
						<a href=mailto:admin@prajwalkoirala.com><svg x="0" y="0" width="32" height="32" viewBox="0 0 485.2 485.2" xml:space="preserve">
						...
						<li>
							<a target="_blank" href=https://goo.gl/maps/5WFYyt2QDzp><svg x="0" y="0" width="32" height="32" viewBox="0 0 430.1 430.1" xml:space="preserve">
