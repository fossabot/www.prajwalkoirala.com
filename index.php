...
<html>
   <head>
      ...
      <meta content="PrajwalKoirala Inc. is a holding company that gives ambitious projects the resources, freedom, and focus to make their ideas happen."name=description>
   ...
   <body>
      <div id=wrapper>
      <section id=main>
         <span class=avatar><img alt="Prajwal Koirala"src=https://www.prajwalkoirala.com/avatar.png title=Avatar></span>
         <h1>Prajwal Koirala</h1>
         <li>
            <style>li{display:inline-block;padding:.675em .5em}</style>
            <a href=tel:+1 914-426-4179>
               <svg height=32 viewBox="0 0 578.1 578.1"width=32 x=0 xml:space=preserve y=0>
         ...
         <li>
            <a href=mailto:admin@prajwalkoirala.com>
               <svg height=32 viewBox="0 0 485.2 485.2"width=32 x=0 xml:space=preserve y=0>
         ...
         <li>
            <a href=https://goo.gl/maps/5WFYyt2QDzp target=_blank>
               <svg height=32 viewBox="0 0 430.1 430.1"width=32 x=0 xml:space=preserve y=0>
